<template>
  <VueFinalModal
    ...
    content-class="bg-light rounded-3 shadow-lg"
  ...
  >
    <div :style="{ width: width + 'px', height: height + 'px' }">
      <header
        class="d-flex py-2 px-3 justify-content-between align-items-center border-bottom"
      >
        <h3>{{ title }}</h3>
      ...
      <footer
        class="d-flex flex-row-reverse py-2 px-3 border-top gap-2 align-items-center"
      >
