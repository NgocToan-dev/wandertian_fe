<template>
  <div class="nav justify-content-end border-bottom py-3 px-4 gap-3">
    ...
    >
      ...
      ></i>
      <span
        class="total-notify position-absolute top-20 start-90 translate-middle badge rounded-pill bg-danger"
      >
        {{ totalNotify }}
    ...
    <ul class="dropdown-menu notification-dropdown">
      <div
        class="dropdown-header d-flex justify-content-between align-items-center border-bottom"
      >
